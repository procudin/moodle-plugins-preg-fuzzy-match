<?php
/* Driver template for the PHP_qtype_preg_dot_rGenerator parser generator. (PHP port of LEMON)
*/
 ...
 */
class qtype_preg_dot_yyToken implements ArrayAccess
{
    public $string = '';
    ...
    {
        if ($s instanceof qtype_preg_dot_yyToken) {
            $this->string = $s->string;
            $this->metadata = $s->metadata;
        } else {
            $this->string = (string) $s;
            if ($m instanceof qtype_preg_dot_yyToken) {
    ...
    function offsetSet($offset, $value)
    {
        if ($offset === null) {
            if (isset($value[0])) {
                $x = ($value instanceof qtype_preg_dot_yyToken) ?
        ...
        if ($value instanceof qtype_preg_dot_yyToken) {
            if ($value->metadata) {
 ...
 */
class qtype_preg_dot_yyStackEntry
{
...
#line 2 "../preg_dot_parser.y"

    global $CFG;
#line 103 "../preg_dot_parser.php"

// declare_class is output here
#line 6 "../preg_dot_parser.y"
class qtype_preg_dot_parser#line 108 "../preg_dot_parser.php"
{
/* First off, code is included which follows the "include_class" declaration
** in the input file. */
#line 7 "../preg_dot_parser.y"
...
*/
  ...
  '$',             'DIGRAPH',       'CLOSEBODY',     'START',
  'END',           'TRANSITIONSTATES',  'COMMA',         'STYLE',
 ...
 /*  23 */ "transition_desc ::= OPEN LEAF CLOSE",
            ...
            if ($yyact >= self::YYNSTATE && $yyact < self::YYNSTATE + self::YYNRULE) {
                ...
                do {
                    ...
                    if ($nextstate < self::YYNSTATE) {
                        ...
                        $this->yyidx++;
                        $x = new qtype_preg_dot_yyStackEntry;
                        $x->stateno = $nextstate;
    ...
    function yy_shift($yyNewState, $yyMajor, $yypMinor)
    {
        ...
        $yytos = new qtype_preg_dot_yyStackEntry;
...
#line 53 "../preg_dot_parser.y"
	...
	$this->yystack[$this->yyidx + -1]->minor->to = $toid;
...
#line 118 "../preg_dot_parser.y"
    ...
    foreach ($this->yystack[$this->yyidx + -2]->minor as $tag) {
        ...
        $open->subpattern = $tag;
        $this->_retvalue->opentags[] = $open;
    }
    foreach ($this->yystack[$this->yyidx + 0]->minor as $tag) {
...
#line 998 "../preg_dot_parser.php"
    ...
    function yy_reduce($yyruleno)
    {
        ...
        //qtype_preg_dot_yyStackEntry $yymsp;            /* The top of the parser's stack */
