...
/**
 * Represents final state mismatch while fa equivalence check
 */
class final_state_mismatch extends mismatched_pair {
    public function __construct($matchedautomaton, $pair)
    {
        parent::__construct(mismatched_pair::FINAL_STATE, $matchedautomaton, $pair);
    }
}