...
/**
 * Represents character mismatch while fa equivalence check
 */
class character_mismatch extends mismatched_pair {
    public function __construct($matchedautomaton, $pair)
    {
        parent::__construct(mismatched_pair::CHARACTER, $matchedautomaton, $pair);
    }
}