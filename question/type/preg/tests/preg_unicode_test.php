...
class qtype_preg_unicode_test extends PHPUnit\Framework\TestCase {
    ...
    function test_get_ranges_from_charset() {
        $ranges = qtype_preg_unicode::get_ranges_from_charset(new qtype_poasquestion\utf8_string('a'));
        ...
        $ranges = qtype_preg_unicode::get_ranges_from_charset(new qtype_poasquestion\utf8_string('ab'));
        $this->assertTrue(count($ranges) === 1);
        $this->assertTrue($ranges[0][0] === core_text::utf8ord('a'));
        $this->assertTrue($ranges[0][1] === core_text::utf8ord('b'));

        $ranges = qtype_preg_unicode::get_ranges_from_charset(new qtype_poasquestion\utf8_string('abc'));
        $this->assertTrue(count($ranges) === 1);
        $this->assertTrue($ranges[0][0] === core_text::utf8ord('a'));
        $this->assertTrue($ranges[0][1] === core_text::utf8ord('c'));

        $ranges = qtype_preg_unicode::get_ranges_from_charset(new qtype_poasquestion\utf8_string('abde'));
        ...
        $ranges = qtype_preg_unicode::get_ranges_from_charset(new qtype_poasquestion\utf8_string('acdfghj'));
