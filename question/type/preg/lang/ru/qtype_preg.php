...
$string['fuzzymatch'] = 'Нечеткий поиск';
$string['fuzzymatch_help'] = 'Нечеткий поиск позволяет учитывать определенное число опечаток при ответе. При наличии опечаток в строке ответ считается частично правильным.';
$string['maxerrors'] = 'Максимальное количество ошибок для нечеткого поиска';
$string['maxerrors_help'] = 'Верхний предел количества ошибок, превышение которого приводит к оценке ответа как неправильного.';
$string['errorspenalty'] = 'Штраф за каждую найденную ошибку';
$string['errorspenalty_help'] = 'Штраф за каждую найденную нечетким поиском ошибку.';
$string['usehowtofixpichint'] = 'Разрешить подсказку о том, как исправить строку';
$string['usehowtofixpichint_help'] = 'Позволяет визуально указать студенту, какие действия нужно применить, чтобы ответ стал правильным.';
