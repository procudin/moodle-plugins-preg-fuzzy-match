...
$string['simplification_equivalences_full_2_1'] = 'Скобки не влияют на работу регулярного выражения, их можно удалить';
...
$string['simplification_equivalences_full_3_1'] = 'Скобки не влияют на работу регулярного выражения, т.к. на них нет обратной ссылки или условной подмаски, их можно удалить';
$string['simplification_equivalences_short_4'] = 'Повторяющееся подвыражение';
...
$string['simplification_equivalences_short_8'] = 'Лишняя пустота в альтернативе';
$string['simplification_equivalences_full_8'] = 'Удобнее записать с помощью "?"';
$string['simplification_equivalences_short_9'] = 'Лишний квантификатор "?"';
$string['simplification_equivalences_full_9'] = 'Можно убрать квантификатор "?" у альтернативы, добавив к ней пустую альтернативу';
$string['simplification_equivalences_short_10'] = 'Замена двух квантификаторов одним';
$string['simplification_equivalences_full_10'] = 'Два вложенных повторения можно заменить одним';
$string['simplification_equivalences_short_11'] = 'Замена квантификатора на эквивалентный';
$string['simplification_equivalences_full_11'] = 'Квантификатор %квантификатор% эквивалентен %квантификатор%';
...
$string['simplification_tips_short_2'] = 'Увеличить количество пробельных символов';
$string['simplification_tips_full_2'] = 'Возможно вы хотите разрешить любое количество пробельных символов в этом месте, для этого следует использовать квантификатор "+"';
$string['simplification_tips_short_3'] = 'Лишние круглые скобки, для которых нет обратной ссылки';
$string['simplification_tips_full_3'] = 'Круглые скобки позволяют запоминать совпадения с этим участком выражения. Если вам это не нужно, то круглые скобки можно заменить на группировку "(?:)"';
$string['simplification_tips_short_4'] = 'Всего один пробельный символ';
...
$string['simplification_tips_full_5'] = 'Выражение совпадает с любой строкой';
$string['simplification_tips_short_6'] = 'Использовать опцию (?i) вместо символьного класса с парными заглавными и строчными буквами';
...
$string['simplification_tips_short_8'] = 'Лишние утверждения слева и справа';
