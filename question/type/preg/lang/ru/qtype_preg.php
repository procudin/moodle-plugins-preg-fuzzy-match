...
$string['maxerrors'] = 'Максимальное количество опечатко для нечеткого поиска';
$string['maxerrors_help'] = 'Верхний предел количества опечаток, превышение которого приводит к оценке ответа как неправильного.';
$string['errorspenalty'] = 'Штраф за каждую найденную ошибку';
$string['errorspenalty_help'] = 'Штраф за каждую найденную поиском ошибку.';
$string['usehowtofixpichint'] = 'Разрешить подсказку о том, как исправить строку';
