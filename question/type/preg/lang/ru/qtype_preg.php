...
$string['noapproximateforhowtofixpichint'] = 'Необходимо включить анализ опечаток и установить предел опечаток выше нуля для подсказки "как можно исправить" ';

$string['hinting'] = 'Настройки подсказок';
$string['hinting_help'] = 'Настройки подсказок позволяют вам задать доступность подсказок и штрафы за них.';
$string['typoanalysis'] = 'Анализ опечаток';
$string['typoanalysis_help'] = 'Анализ опечаток предполагает, что студент может совершать небольшие ошибки внутри ответа.';
$string['approximatematch'] = 'Учитывать опечатки';
$string['approximatematch_help'] = 'Учет опечаток позволяет учитывать определенное число опечаток при ответе. При наличии опечаток в строке ответ считается частично правильным.';
$string['maxerrors'] = 'Максимальное количество опечаток';
$string['maxerrors_help'] = 'Верхний предел количества опечаток, превышение которого приводит к оценке ответа как неправильного.';
$string['errorspenalty'] = 'Штраф за каждую найденную опечатку';
$string['errorspenalty_help'] = 'Штраф за каждую найденную поиском опечатку.';
$string['usehowtofixpichint'] = 'Разрешить подсказку "как можно исправить" (картинка)';
$string['usehowtofixpichint_help'] = 'Позволяет визуально указать студенту, какие операции нужно применить к строке, чтобы ответ стал правильным.';
$string['hinthowtofixpic'] = 'как исправить';
$string['howtofixpichintpenalty'] = 'Штраф за подсказку "как можно исправить"';
$string['howtofixpichintpenalty_help'] = 'Штраф за подсказку "как можно исправить".';
