 ...
 * @return array
 */
function qtype_preg_compute_font_metrics() {
 ...
 */
global $metrics;
$metrics = qtype_preg_compute_font_metrics();


function qtype_preg_letter_width($text) {
    global $metrics;
 ...
 */
function qtype_preg_get_text_bounding_box($text)  {
    global $metrics;
 ...
 * @return int kerning
 */
function qtype_preg_compute_kerning($a, $b) {
 ...
 */
function qtype_preg_render_text(&$im, $x, $y, $text, $color) {
    global $metrics;
