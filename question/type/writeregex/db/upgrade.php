...
function xmldb_qtype_writeregex_upgrade($oldversion = 0) {
    ...
    if ($oldversion < 2015121700) {
        ...
        $table = new xmldb_table('qtype_writeregex_options');
        $field = new xmldb_field('compareregexpercentage', XMLDB_TYPE_FLOAT, '12, 7', null, XMLDB_NOTNULL, null, null, 'teststringshintpenalty');
        ...
        $table = new xmldb_table('qtype_writeregex_options');
        $field = new xmldb_field('compareregexpteststrings', XMLDB_TYPE_FLOAT, '12, 7', null, XMLDB_NOTNULL, null, null, 'compareautomatapercentage');
