...
$string['extracharactermismatchfrombeginning'] = 'Your answer accepts character \'{$a->character}\' at the beginning while correct one doesn\'t';
$string['missingcharactermismatchfrombeginning'] = 'Your answer doesn\'t accept character \'{$a->character}\'  at the beginning while correct one does';
$string['extracharactermismatch'] = 'Your answer accepts character \'{$a->character}\' after matching the string \'{$a->matchedstring}\' while correct one doesn\'t';
$string['missingcharactermismatch'] = 'Your answer doesn\'t accept character \'{$a->character}\' after matching the string \'{$a->matchedstring}\' while correct one does';
$string['extrafinalstatemismatch'] = 'Your answer accepts the string \'{$a}\' while correct one doesn\'t';
$string['missingfinalstatemismatch'] = 'Your answer doesn\'t accept the string \'{$a}\' while correct one does';