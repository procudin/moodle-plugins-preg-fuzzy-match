...
$string['automataanalyzersoverflowforstudent'] = 'Не удалось проверить правильность ответа. Позовите преподавателя, чтобы решить проблему.';
$string['automataanalyzersoverflowforteacher'] = 'Проверка эквивалентности данного ответа с ответом студента при помощи анализатора на конечных автоматах может занять долгое время - превышено ограничение на максимальное количество пар групп на одном шаге алгоритма проверки эквивалентности конечных автомтаов. Для изменения ограничения обратитесь к администратору сайта.';
...
$string['showmismatchedteststrings'] = 'Показывать несовпавшие тестовые строки';
$string['showmismatchedteststrings_help'] = 'Будут ли показываться студенту в качестве результатов проверки тестовые строки, которые не совпали с правильным ответом';
$string['showmismatchedteststringsfalse'] = 'Нет, не показывать';
$string['showmismatchedteststringstrue'] = 'Да, показывать';
$string['stringmismatchpenalty'] = 'Штраф за одно расхождение по совпадающим строкам';
...
$string['subpatternmismatchpenalty'] = 'Штраф за одно расхождение по подмаске';
...
$string['teststringsmatchedcount'] = 'Количество совпавших тестовых строк: {$a->matchedcount}/{$a->count}.';
